...
const docTemplate = `{
    ...
    "paths": {
        "/statistics": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Начало промежутка рассмотрения статистики (включительно), формат: ГГГГ-ММ-ДД",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Конец промежутка рассмотрения статистики (не включительно), формат: ГГГГ-ММ-ДД",
                        "name": "to",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_Astek27_todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/internal_features_tasks_transport_http.PatchedTaskResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request",
        ...
        "/users": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Успешное получение спписка пользователей",
                        "schema": {
                            "type": "array",
                            "items": {
    ...
    "definitions": {
        "github_com_Astek27_todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "internal_features_tasks_transport_http.PatchedTaskResponse": {
            "type": "object",
            "properties": {
                "author_user_id": {
                    "type": "integer",
